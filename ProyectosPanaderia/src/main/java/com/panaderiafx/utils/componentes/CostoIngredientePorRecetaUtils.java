...
public class CostoIngredientePorRecetaUtils {
    ...
    private static void cargarTablas() {
        if (TABLA_RECETAS == null) TABLA_RECETAS = VerUtils.verTabla("Recetas");
        if (TABLA_RECETAS_INGREDIENTES == null) TABLA_RECETAS_INGREDIENTES = VerUtils.verTabla("RecetasIngredientes");
        if (TABLA_INGREDIENTES == null) TABLA_INGREDIENTES = VerUtils.verTabla("Ingredientes");
    }
    ...
    public static double calcular(String codReceta, String codIngrediente, double ignorado) {
        ...
        if (cachePorReceta.containsKey(codReceta) && cachePorReceta.get(codReceta).containsKey(codIngrediente)) {
